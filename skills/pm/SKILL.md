  ...
  "positions": [
    {
      ...
      "memo": {
        ...
        "earnings_path": "string (1-2 paragraphs: the explicit earnings case — current EPS or earnings proxy, the specific mechanism the thesis predicts will drive margin or earnings improvement (anchored to a peer company that has already realized it, with their before/after numbers), resulting target EPS, the historical P/E context (current vs. 5-yr average), target P/E applied, implied price target $H, current price, and % upside. If EPS is negative, use gross profit or revenue multiple and explain.)",
        ...
        "key_risks": "string (1 paragraph: the 2-3 risks most likely to make this idea wrong — must address the mirror-image risk: if the thesis mechanism also affects the company's customers or counterparties, does that compress the revenue base even as margins improve?)"
      }
    }
  ],
